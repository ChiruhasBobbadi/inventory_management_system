                ...
                <div class="col-lg-3 col-xs-6">
                    ...
                    <div class="small-box bg-lime">
                        <div class="inner">
                            ...
                            <h3><b><sup style="font-size: 20px">Add New</sup></b></h3>
                        ...
                        <a href="views/MemberShip.jsp" class="small-box-footer">Add Info <i class="fa fa-arrow-circle-right"></i></a>
                    </div>
                </div>
                <!-- ./col -->
                <div class="col-lg-3 col-xs-6">
                    ...
                    <div class="small-box bg-blue">
                        <div class="inner">
                            <h3><b><sup style="font-size: 26px">Member List</sup></b></h3>
                        ...
                        <a href="views/MemberList.jsp" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
                    </div>
                </div>
                <!-- ./col -->
