                        ...
                        <div class="col-lg-3 col-xs-6">
                            ...
                            <div class="small-box bg-green-gradient">
                                <div class="inner">
                                    ...
                                    <h3><sup style="font-size: 18px">Details Of Supplier</sup></h3>

                                    <p>Details Of Supplier</p>
                                    
                                </div>
                                <div class="icon">
                                    <i class="ion ion-ios-contact-outline"></i>
                                </div>
                                <a href="views/Dealership.jsp" class="small-box-footer">Add Info <i class="fa fa-arrow-circle-right"></i></a>
                            </div>
                        </div>
                        <!-- ./col -->
