...
<html>
    ...
    <body class="hold-transition skin-blue sidebar-mini">
        ...
        <section class="content">
            ...
            <main>
                <div class="container">
                    <legend><h2>Sale Information</h2></legend>
                    <table>
                        <tr>
                            <td>
                                <div class="form-group">
                                    <label for="">Search Date: </label>
                                    <input type="date" class="form-control" id="" name="pdate" placeholder="">
                                </div>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <table class="table table-striped">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>250</td>
                                        <td>
                                            <a href="#"  class="btn btn-info btn-sm btn-icon icon-left" role="button">
