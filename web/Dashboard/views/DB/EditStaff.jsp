                ...
                <section class="content">
                    ...
                    <main>
                        <div class="panel panel-primary">
                            ...
                            User u=UserDao.getStaffRecordMemberById(Integer.parseInt(id));
                                %>
                        ...
                        <tr> 
                            <td><div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="staff_id" name="staff_id" value="<%= u.getStaff_id()%>" placeholder="Enter Your User Id">
                                </div><br></td>
                            <td><div class="form-group">
                                    <label for="password">Password:</label><br>
                                    <input type="text" class="form-control" id="password" name="password" value="<%= u.getPassword()%>" placeholder="Enter Your Password">
                                </div><br></td>
                        </tr>
                        <tr>
                            <td>
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="name" name="name" value="<%= u.getName()%>" placeholder="Enter Your Name">
                                </div><br>
                            </td>
                            <td>
                                <div>
                        ...
                        <tr>
                            <td>
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="mobile_no" name="mobile_no" value="<%= u.getMobile_no()%>"  placeholder="Enter Your Mobile No">
                                </div><br>
                            </td>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" rows="3" id="per_address" name="per_address" value=""><%= u.getPer_address()%></textarea>
                                </div><br>
                            </td>
                        </tr>
                        <tr>
