...
<a href="../../../http://localhost:8080/inventory_war_exploded">Please Login</a>
<%} else {
                ...
                <section class="content">
                    ...
                    <main>
                        <div class="panel panel-primary">
                            ...
                            User u=UserDao.getRecordByDealerId(Integer.parseInt(id));
                                %>

                                <form class="col-xs-12 col-sm-6 col-md-4 col-sm-offset-3 col-md-offset-4" action="UpdateDealer.jsp">
                                    <input type="hidden" name="id" value="<%=u.getId() %>"/>
                                    <label><h1>Supplier Information</h1></label>
                                    <table>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="dealer_name" value="<%= u.getDealer_name()%>" placeholder="">
                                                </div>
                                            </td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="form-group">
                                                    ...
                                                    <input type="customer id" class="form-control" value="<%= u.getDealer_id()%>" name="dealer_id"  placeholder="Enter Quantity">
                                                </div>
                                            </td>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" value="<%= u.getContact()%>" name="contact" placeholder="Enter Quantity">
                                                </div>
                                            </td>
                                        </tr>
                                        <tr> 
                                            <td>
                                                <div class="form-group">
                                                    ...
                                                    <textarea type="text" class="form-control" value="" name="address" id="customer id" placeholder=""><%= u.getAddress()%></textarea>
                                                </div>
                                            </td>
                                        </tr>
                                        <tr> 
                                        ...
                                        <tr>
                                            <td>
                                                <div class="form-group">
                                                    ...
                                                    <input type="date" class="form-control" value="<%= u.getDate()%>" name="date" placeholder="Enter date">
                                                </div>
                                            </td>
                                        </tr>
