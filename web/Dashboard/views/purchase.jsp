                    ...
                    <li class="dropdown user user-menu">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="user-header">
                                ...
                                <p>
                                    <i style="font-size: 18px"><%=session.getAttribute("userid")%>
                                    </i><br>
                                    E mart
                                    <small></small>
                                </p>
                    ...
                    <form class="form-inline" action="DB/InsertPurchase.jsp" method="post">
                        <table>
                            <tr>
                                ...
                                <td>
                                    <%@page import="com.inventory.bean.User" %>
                                    <%@page import="com.inventory.dao.UserDao, java.sql.Wrapper, java.util.List" %>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="form-group">
                                        ...
                                        <input type="price" class="form-control" id="price" NAME="per_unit_price"
                                               placeholder="Enter Per-Unit_price" required>
                                    </div>
                                </td>
                            </tr>
                            ...
                            <tr>
                                <td>
                                    <div class="form-group">
                                        ...
                                        <input type="date" name="product_exp_date" class="form-control" id="mobile"
                                               pattern="^\d{5}-\d{6}}$" required>
                                    </div>
                                    <br>
                                ...
                                <td>
                                    <div class="form-group">
                                        ...
                                        <input type="date" name="purchase_date" class="form-control" id="mobile"
                                               pattern="^\d{5}-\d{6}}$" required>
                                    </div>
                                    <br>
