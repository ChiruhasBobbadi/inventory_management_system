                        ...
                        <div class="col-lg-3 col-xs-6">
                            ...
                            <div class="small-box bg-orange">
                                <div class="inner">
                                    ...
                                    <h3><b><sup style="font-size: 20px">Product Purchase</sup></b></h3>
                                ...
                                <a href="views/purchase.jsp" class="small-box-footer">Add Info <i class="fa fa-arrow-circle-right"></i></a>
                            </div>
                        </div>
                        <!-- ./col -->
                        <div class="col-lg-3 col-xs-6">
                            ...
                            <div class="small-box bg-blue">
                                <div class="inner">
                                    <h3><sup style="font-size: 26px">Product List</sup></h3>
                                ...
                                <a href="views/ProductList.jsp" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
                            </div>
                        </div>
                        <!-- ./col -->
